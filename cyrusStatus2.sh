...
cd ../bootq;echo $PWD;git branch;git status| grep '*'
cd ../notes;echo $PWD;git branch;git status| grep '*'
cd ../shleemy;echo $PWD;git branch;git status| grep '*'
cd ../kogitoq2;echo $PWD;git branch;git status| grep '*'
...
cd ../prj_lojing;echo $PWD;git branch;git status| grep '*'
cd ../prj_credmatch;echo $PWD;git branch;git status| grep '*'
cd ../genny-main
