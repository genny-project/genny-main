...
CREATE TABLE `Attachment` (
  ...
  `attachedBy_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `AuditTaskImpl` (
  ...
  `actualOwner` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdBy` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdOn` datetime(6) DEFAULT NULL,
  `deploymentId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `DeploymentStore` (
  ...
  `deploymentUnit` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `ErrorInfo` (
  ...
  `stacktrace` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ExecutionErrorInfo` (
  ...
  `ERROR_ACK_BY` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `ERROR_ID` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `I18NText` (
  ...
  `shortText` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `NodeInstanceLog` (
  ...
  `nodeContainerId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nodeId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nodeInstanceId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nodeName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nodeType` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `processId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `processInstanceId` bigint NOT NULL,
...
CREATE TABLE `Notification_email_header` (
  ...
  `mapkey` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `ProcessInstanceLog` (
  `id` bigint NOT NULL,
  `correlationKey` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `duration` bigint DEFAULT NULL,
  ...
  `processId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `processInstanceDescription` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `processInstanceId` bigint NOT NULL,
  `processName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `processType` int DEFAULT NULL,
  `processVersion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slaCompliance` int DEFAULT NULL,
  `sla_due_date` datetime(6) DEFAULT NULL,
...
CREATE TABLE `QueryDefinitionStore` (
  `id` bigint NOT NULL,
  `qExpression` longtext COLLATE utf8mb4_unicode_ci,
  `qName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qSource` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qTarget` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `RequestInfo` (
  `id` bigint NOT NULL,
  `commandName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deploymentId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `executions` int NOT NULL,
  `businessKey` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `Task` (
  ...
  `allowedToDelegate` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `formName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `priority` int NOT NULL,
  `subTaskStrategy` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `faultName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `faultType` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `outputAccessType` int DEFAULT NULL,
  `outputContentId` bigint NOT NULL,
  `outputType` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parentId` bigint NOT NULL,
  ...
  `OPTLOCK` int DEFAULT NULL,
  `taskInitiator_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `actualOwner_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdBy_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `VariableInstanceLog` (
  ...
  `variableInstanceId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `answer` (
  ...
  `attributecode` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `sourcecode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `answerlinks` (
  `be_list` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `askId` bigint DEFAULT NULL,
  ...
  `valueString` longtext COLLATE utf8mb4_unicode_ci,
  ...
  `valueMoney` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ask` (
  ...
  `questionCode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `attribute` (
  ...
  `dttCode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `inputmask` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `typeName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `validation_list` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `baseentity` (
  ...
  `code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int DEFAULT NULL,
  `capabilityRequirements` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `baseentity_baseentity` (
  `targetCode` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created` datetime(6) DEFAULT NULL,
  `LINK_CODE` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `childColor` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linkValue` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parentColor` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `RULE` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SOURCE_CODE` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `TARGET_CODE` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `context` (
  ...
  `realm` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `updated` datetime(6) DEFAULT NULL,
  `contextCode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `FKe59hoiclldhfdsgudwwyekisn` (`list_id`),
  CONSTRAINT `FKe59hoiclldhfdsgudwwyekisn` FOREIGN KEY (`list_id`) REFERENCES `ask` (`id`),
...
CREATE TABLE `email_header` (
  ...
  `language` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `replyToAddress` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subject` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ispn_cache_jobs`
--

DROP TABLE IF EXISTS `ispn_cache_jobs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ispn_cache_jobs` (
  `id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `data` longblob NOT NULL,
  `updated` bigint NOT NULL,
  `segment` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ispn_cache_jobs_timestamp_index` (`updated`),
  KEY `ispn_cache_jobs_segment_index` (`segment`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ispn_cache_jobs_META`
--

DROP TABLE IF EXISTS `ispn_cache_jobs_META`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ispn_cache_jobs_META` (
  `data` longblob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ispn_cache_processinstances`
--

DROP TABLE IF EXISTS `ispn_cache_processinstances`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ispn_cache_processinstances` (
  `id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `data` longblob NOT NULL,
  `updated` bigint NOT NULL,
  `segment` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ispn_cache_processinstances_timestamp_index` (`updated`),
  KEY `ispn_cache_processinstances_segment_index` (`segment`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ispn_cache_processinstances_META`
--

DROP TABLE IF EXISTS `ispn_cache_processinstances_META`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ispn_cache_processinstances_META` (
  `data` longblob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ispn_cache_usertaskinstances`
--

DROP TABLE IF EXISTS `ispn_cache_usertaskinstances`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ispn_cache_usertaskinstances` (
  `id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `data` longblob NOT NULL,
  `updated` bigint NOT NULL,
  `segment` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ispn_cache_usertaskinstances_timestamp_index` (`updated`),
  KEY `ispn_cache_usertaskinstances_segment_index` (`segment`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ispn_cache_usertaskinstances_META`
--

DROP TABLE IF EXISTS `ispn_cache_usertaskinstances_META`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ispn_cache_usertaskinstances_META` (
  `data` longblob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nodestatus` (
  ...
  `workflowBeCode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `workflowStage` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `question_question` (
  `sourceCode` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `targetCode` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `createOnTrigger` bit(1) DEFAULT NULL,
  `created` datetime(6) DEFAULT NULL,
...
CREATE TABLE `session_pid` (
  ...
  `realm` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sessioncode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sessionend` datetime(6) DEFAULT NULL,
  `usercode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `task_comment` (
  ...
  `text` longtext COLLATE utf8mb4_unicode_ci,
  `addedBy_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `template` (
  ...
  `sms` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `validation` (
  ...
  `options` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recursiveGroup` bit(1) DEFAULT NULL,
  `regex` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `selection_grp` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-05-07 12:08:26
