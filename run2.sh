...
ENV_FILE=$ENV_FILE docker-compose -f docker-compose2.yml up -d
ENV_FILE=$ENV_FILE docker-compose -f docker-compose2.yml logs -f bridge rulesservice qwanda-service
